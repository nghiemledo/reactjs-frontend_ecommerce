...
const CartPage = () => {
  ...
  useEffect(() => {
    const newTotal = cartItem.reduce((acc, item) => {
      return acc + 43 + parseFloat(item.price) * item.amount - item.discount;
    }, 0);
      ...
      {cartItem.length == 0 ? (
        <div style={{ alignItems: "center", textAlign: "center" }}>
          ...
          <Link
            ...
            style={{ width: "230px", marginTop: "20px", borderRadius: "3px" }}
          >
            Shop Now
          </Link>
        </div>
        ...
        <div className="row">
          <div style={{ display: "flex" }}>
            ...
            >
              <img src={removeIcon} width={15} height={15} /> Clear cart
            </div>
            <div
              ...
              <div className="modal-dialog">
                <div className="modal-content" style={{ textAlign: "center" }}>
                  <div className="modal-body">
                    ...
                    <br />
                    <p>
                      Do you really want to delete all record? This process
                      cannot be undone.
                    </p>
                    <button
                      type="button"
                      ...
                      <div className="flex-grow-1 align-self-center overflow-hidden">
                        <div>
                          <h5 className="text-truncate font-size-18">
                            <a href="#" className="text-dark fw-bold fs-5z">
                              {item.name}
                            </a>
                          </h5>
                        </div>
